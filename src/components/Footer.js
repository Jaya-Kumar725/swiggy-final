        ...
        <div>
            <div className="container-fluid" style={{ backgroundColor: "black" }}>
                <div className="row">
                    ...
                    <div className='col-lg-3'>
                        <div>
                            <ul style={{ listStyle: 'none', padding: '10px', color: 'white' }}>
                    ...
                    <div className='container'>
                        <div
                            className='row'
                            style={{ marginTop: '15px', marginLeft: '8px',cursor:"pointer",color:"white" }}
                        >
                            <div className='col'>
                                <b
                    ...
                    <div className='row'>
                        <div className='col-lg-2 mt-5' style={{position:"relative",bottom:"5px"}}>
                            <img
                        ...
                        <div className='col-lg-5 text-right mt-5 text-white'style={{position:"relative",left:"24rem"}}>
                            <h5 className='mt-2'>
                                <span>&#169;</span> 2021 Swiggy{' '}
                            </h5>
                        </div>
                        <div className='col-lg-5' style={{position:"relative",textAlign:"right"}}>
                            <div className='row'>
                                <div
